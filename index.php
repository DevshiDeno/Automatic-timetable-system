...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIMETABLE GENERATOR SYSTEM</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/lab.jpg" alt="Chania">
        </div>
        ...
        <div class="item">
            <img src="assets/img/lab.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/deno.jpg" class="img-rounded"/>
                    <h3 align="center">Prof. Gichuru</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>Computing and Informatics</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. Kamau</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> Dennis</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. Muturi</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>Computing AND INFORMATICS Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Nchiru </h4>
                <h4><strong>Call:</strong>0718705129 </h4>
                <h4><strong>Email: </strong>kamaudennis@gmail.com.com</h4>
            </div>
