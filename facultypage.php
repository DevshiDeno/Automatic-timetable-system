...
<form action="facultypage.php" method="post">
    ...
    <select name="select_semester" class="list-group-item">
            ...
            <option value="1"> I Year ( Semester I )</option>
            <option value="2"> I Year ( Semester II )</option>
            <option value="3"> II Year ( Semester I )</option>
            <option value="4"> II Year ( Semester II )</option>
            <option value="5"> III Year ( Semester I )</option>
            <option value="6"> IV Year ( Semester I )</option>
            <option value="7"> IV Year ( Semester II )</option>
        </select>
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        echo "COMPUTING AND INFORMATICS DEPARTMENT SEMESTER " . $_POST['select_semester'] . " ";
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTING AND INFORMATICS DEPARTMENT";
...
<div align="center" style="margin-top: 10px">
    <button id="saveaspdf" class="btn btn-info btn-lg">SAVE AS PDF</button>
</div>


<script src="assets/jquery/3.5.1/jquery.min.js"></script>
<script src="assets/jspdf/1.3.5/jspdf.min.js"></script>
<script>
$(document).ready(function () {  
    ...
    function createPDF() {  
        getCanvas().then(function (canvas) {  
            ...
            doc.save('<?php if (isset($_POST["select_semester"])) { echo "ttms semester " . $_POST["select_semester"]; } else if (isset($_POST["select_teacher"])) { echo "ttms " . $_POST["select_teacher"];  } else if (isset($_SESSION["loggedin_id"])) { echo "ttms " . $_SESSION["loggedin_id"]; } ?>' + '.pdf');  
