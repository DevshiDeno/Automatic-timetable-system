    ...
    <table border="2" cellspacing="3" align="center" id="timetable">
        <caption>
            <strong><br><br>
                ...
                if (isset($_POST['select_semester'])) {
                    echo "COMPUTER AND INFORMATICS DEPARTMENT SEMESTER " . $_POST['select_semester'] . " ";
        ...
        <tr>
            ...
            if (isset($_POST['select_semester']) ) {
                ...
                echo '</table>';
                $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER AND INFORMATICS DEPARTMENT, SCI.";
                if (isset($_POST['select_semester'])) {
